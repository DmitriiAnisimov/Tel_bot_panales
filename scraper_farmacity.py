    ...
    def scrape_data(self):
        ...
        with open(self.csv_file_path, mode='w', newline='', encoding='utf-8') as file:
            ...
            for page in range(1, self.page_count + 1):
                ...
                time.sleep(15)
                product_cards = driver.find_elements(By.CSS_SELECTOR, 'div.vtex-search-result-3-x-galleryItem')

                for card in product_cards:
                    text_element = card.find_element(By.CSS_SELECTOR, self.description_css)
                    try:
                        price_element = card.find_element(By.CSS_SELECTOR, self.price_css)
                    except:
                        price_element = card.find_element(By.CSS_SELECTOR, self.price_css_2)
                    link_element = card.find_element(By.CSS_SELECTOR, self.link_css)
